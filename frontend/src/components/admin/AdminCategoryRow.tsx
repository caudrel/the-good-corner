...
export default function AdminCategoryRow({ category: { id, name }, handleDeleteCategory }: AdminCategoryRowProps) {
      ...
      <td>
        {isEditing ? (
          ...
          <div>
            ...
            <button
              onClick={() => {
                if (confirm("voulez vous vraiement supprimer la categorie ? Toutes les annonces liées seront également supprimées"))
