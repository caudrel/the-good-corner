...
import { useDeleteAdMutation, useGetAdByIdQuery } from "@/graphql/generated/schema";
            ...
            <div className="">
              ...
              <div className="flex justify-between mb-6">
                <div className="flex items-center mt-3">
                  <UserCircleIcon width={24} height={24} className="mr-2" /> {ad.owner}
                </div>
              ...
              <div className="flex justify-between border-t pt-2 items-center ">
                <Link href={`/editAd/${ad.id}`} className="flex items-center mt-3 cursor-pointer">
                ...
                <div
                  ...
                  onClick={() => {
                    if (confirm("Etes-vous certain.e de vouloir supprimer cette annonce ?"))
